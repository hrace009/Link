      ...
      namespace Link.Net.Protocol.Known.Minimal
      {
        public class ProtoBuilderMinimal : ProtoGenericTable<ProtoBuilderMinimal>
         {
        public static readonly ProtoBuilderMinimal Instance = new ProtoBuilderMinimal();

        public ProtoBuilderMinimal()
        {
